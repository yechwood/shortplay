...
public class MainActivity extends AppCompatActivity {
    ...
    void loadClips(){
        ...
        String[] ic={MediaStore.Images.Media._ID,MediaStore.Images.Media.DISPLAY_NAME,MediaStore.Images.Media.DATE_MODIFIED,MediaStore.Images.Media.RELATIVE_PATH,MediaStore.Images.Media.BUCKET_DISPLAY_NAME,MediaStore.Images.Media.WIDTH,MediaStore.Images.Media.HEIGHT};
        try(Cursor c=getContentResolver().query(iu,ic,null,null,MediaStore.Images.Media.DATE_MODIFIED+" DESC")){
            if(c!=null)while(c.moveToNext()){String f=mediaFolder(c.getString(3),c.getString(4));MediaItemData x=new MediaItemData(ContentUris.withAppendedId(iu,c.getLong(0)),c.getString(1),false,0,c.getLong(2),f,c.getInt(5),c.getInt(6));media.add(x);folders.add(f);}
        }catch(Exception ignored){}
        sortMedia();
    }
